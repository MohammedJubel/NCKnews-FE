...
5. As a user, I should be able to sort articles by:
   - date created
     https://nc-knews-mohammedjubel.herokuapp.com/api/articles?sort_by=created_at
   - comment_count - no comment count
   - votes - Does it work ?
...
1. **As a user, I should be able to navigate over pages of articles (e.g. using pagination or infinite scroll).**
2. **As a user, I should be able to navigate over pages of comments (e.g. using pagination or infinite scroll).**
3. As a user, I should be able to view a list of all articles written by a specific user.

\*Note regarding \*_BOLD\*\* user stories:_
...
**Before moving onto the 'if time' and 'extra credit' sections, submit your code for review! Please send a link to both your GitHub project and your hosted version to the FE2 slack channel** ![grinning](https://github.githubassets.com/images/icons/emoji/unicode/1f600.png)
